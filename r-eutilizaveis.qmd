...
```
:::aside
"Engine" é o motor de renderização (que transforma script em HTML), que pode ser o knitr (do RStudio) ou Jupyter (do Python). O padrão (default) é knitr, mas não sei porque de vez em quando tem que informar manualmente.
:::
...
- 3. Para justificar o texto, pode-se usar:
