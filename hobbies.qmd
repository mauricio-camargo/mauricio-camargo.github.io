...
- A programação entrou na minha vida por necessidade acadêmica do mestrado na Bélgica, em 1993. Na época estava surgindo o [Delphi](https://www.embarcadero.com/br/products/delphi), uma implementação da linguagem Pascal compilada, ou seja, rápida como um raio. Me apaixonei e resolvi todos os problemas do mestrado com o Delphi. Depois fiz dezenas de programas comerciais, acadêmicos e open source com ele, até virar professor, em 20024. Desde então, comecei a programar com o [Lazarus](https://www.lazarus-ide.org), uma alternativa *open source* ao Delphi e multiplataforma. Hoje Lazarus é minha paixão, e disponibilizo diversos programas open source para Linux e Windows no meu [Github](https://github.com/mauricio-camargo). 
