...
Em 2021 (53 anos) decidi elencar 10 hobbies e praticá-los semanalmente. Apareceram 11. Foi a melhor decisão da minha vida. Meu ranking atual (**2026**) dos 11 hobbies é o seguinte:
...
- Em Jan/2026 descobri uma lesão degenerativa no manguito e precisei parar com o vôlei, até que eu consiga algum tipo de reabilitação.
<!--
...
- Coisa boa da vida: tirar um novo solo (tem tudo no [YouTube](https://www.youtube.com/@mauriciocamargofurg/videos)).
</details>

<details>
<summary><strong>7. Moto</strong></summary>
- Tive uma XL-250R em 1992 (24 anos), de um carburador só, que era um tratorzinho. Com ela rodei os estados do PR e SC. Em 2024 (56 anos) comprei uma RE Meteor 350, que tinha um ronco muito parecido com o da XL. Tive que vendê-la em 2026, mas logo, logo vou comprar uma RE Himalayan 450.
...
- Coisa boa da vida: derrotar no xadrez online um russo de 12-13 anos (é tudo o que eu consigo!) 
...
- Minhas especialidades são pizza no forno a lenha,  sushi e feijoada.

- Coisa boa da vida: conzinhar um prato bem complexo sem errar nen esquecer nada!

</details>

<details>
<summary><strong>11. Programação</strong></summary>
- A programação entrou na minha vida por necessidade acadêmica do mestrado na Bélgica, em 1993. Na época estava surgindo o [Delphi](https://www.embarcadero.com/br/products/delphi), uma implementação da linguagem Pascal compilada, ou seja, rápida como um raio. Me apaixonei e resolvi todos os problemas do mestrado com o Delphi. Depois fiz dezenas de programas comerciais, acadêmicos e open source com ele, até virar professor, em 2004. Desde então, comecei a programar com o [Lazarus](https://www.lazarus-ide.org), uma alternativa *open source* ao Delphi e multiplataforma. Hoje Lazarus é minha paixão, e disponibilizo diversos programas open source para Linux e Windows no meu [Github](https://github.com/mauricio-camargo). 

- Programação em R também é minha paixão. Em 2025 dei uma disciplina de Introdução à programação com o R, que funcionou muito bem. Mas R não é um hobby como o Lazarus, que é capaz de criar programas genéricos para qualquer propósito. 
